...
export function AccountStatus() {
    ...
    return (
      <>
        <button
          ...
          className="fixed top-4 right-36 z-40 px-4 py-2 rounded-full text-xs font-medium glass text-secondary transition-all hover:scale-[1.02] active:scale-95"
        >
  ...
  return (
    <div ref={dropdownRef} className="fixed top-4 right-36 z-40">
      <button
